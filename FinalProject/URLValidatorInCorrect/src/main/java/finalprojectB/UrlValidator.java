...
public class UrlValidator implements Serializable {
    ...
    private static final String PORT_REGEX = "^:(\\d{1,3})$"; //BUG HERE FOUND IT: Should be 1,5
    ...
    protected boolean isValidQuery(String query) {
        ...
        return !QUERY_PATTERN.matcher(query).matches(); //BUG HERE: return QUERY_PATTERN.matcher(query).matches();
    }
